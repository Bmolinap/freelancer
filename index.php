...
<body>
    <header>
        <h1 class="titulo">Diseño Web PC-MASTER <span>Freelancer</span></h1>
    </header>
...
<section class="hero">
    <div class="contenido-hero">
      <h2>Diseño y Desarrollo Web <span>Freelancer</span></h2>
        <div class="ubicacion">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map-pin" width="92" height="92" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffc108" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    <h2>Mis Servicios</h2>
      ...
      <div class="servicios"> 
        ...
        <section><!--inicio Contacto-->
            <h2>Contactos</h2>
            <form  method="POST" action="input.php" class="formulario">
                <fieldset>
...
<footer class="footer">
<p>Todos los derechos reservados. Diseño Web PC-MASTER </p>
</footer>
    </body>
</html>